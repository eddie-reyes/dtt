...
This repository contains the **frontend** (React + Vite). It talks to a separate backend API that handles authentication, session management, and AI-generated patient responses. The **backend** repository can be found [here](https://github.com/mgmg23/patient_simulator_backend)
